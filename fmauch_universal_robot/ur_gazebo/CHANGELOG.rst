^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package ur_gazebo_1
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
1.1.8 (2016-12-30)
------------------
* ur_gazebo_1: escape underscore in changelog (`#279 <https://github.com/ros-industrial/universal_robot/issues/279>`_).
* all: update maintainers.
* Contributors: gavanderhoorn

1.1.7 (2016-12-29)
------------------
* ur_gazebo_1: add controller_manager as run dependency.
