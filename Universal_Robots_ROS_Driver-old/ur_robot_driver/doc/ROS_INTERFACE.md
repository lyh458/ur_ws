...
##### controller_config_file (default: "$(find ur_robot_driver_1)/config/ur3e_controllers.yaml")
...
##### controller_config_file (default: "$(find ur_robot_driver_1)/config/ur10_controllers.yaml")
...
##### rtde_input_recipe_file (default: "$(find ur_robot_driver_1)/resources/rtde_input_recipe.txt")

Recipe file used for the RTDE-inputs. Only change this if you know what you're doing.

##### rtde_output_recipe_file (default: "$(find ur_robot_driver_1)/resources/rtde_output_recipe.txt")
...
##### urscript_file (default: "$(find ur_robot_driver_1)/resources/ros_control.urscript")
...
##### controller_config_file (default: "$(find ur_robot_driver_1)/config/ur5_controllers.yaml")
...
##### controller_config_file (default: "$(find ur_robot_driver_1)/config/ur5e_controllers.yaml")
...
##### controller_config_file (default: "$(find ur_robot_driver_1)/config/ur3_controllers.yaml")
...
##### controller_config_file (default: "$(find ur_robot_driver_1)/config/ur10e_controllers.yaml")
