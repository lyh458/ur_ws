 ...
 * **ROS-Service-based replacement of most every-day TP-interactions** offer using UR robots without
   ...
   [dashboard services](ur_robot_driver/doc/ROS_INTERFACE.md#ur_robot_driver_node_1) and the
   [robot_state_helper_1 node](ur_robot_driver/doc/ROS_INTERFACE.md#robot_state_helper_1) for details.
...
## Contents
This repository contains the new **ur_robot_driver_1** and a couple of helper packages, such as:
  ...
  * **ur_controllers**: Controllers introduced with this driver, such as speed-scaling-aware
    controllers.
  * **ur_robot_driver_1**: The actual driver package.
...
## Setting up a UR robot for ur_robot_driver_1
### Prepare the robot
...
To actually start the robot driver use one of the existing launch files
    ...
    $ roslaunch ur_robot_driver_1 <robot_type>_bringup.launch robot_ip:=192.168.56.101
...
button on the TP, or calling `rosservice call /ur_hardware_interface/dashboard/play` as explained [here](https://github.com/UniversalRobots/Universal_Robots_ROS_Driver/issues/33) and [here](ur_robot_driver/doc/ROS_INTERFACE.md#ur_robot_driver_node_1)).

In general, make sure you've completed the following tasks:

1. Install and setup the `External Control` URCap as explained
   [above](#setting-up-a-ur-robot-for-ur_robot_driver_1) (also setup the IP address **of the ROS
